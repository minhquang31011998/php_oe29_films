                        ...
                        <div class="item">
                            ...
                            <div class="card card--big">
                                <div class="card__cover">
                                    ...
                                    <a href="{{ route('frontend.watchMovie', [$movieNomination['slug'], config('config.default_server'), config('config.default_prioritize')]) }}" class="card__play">
                                        <i class="icon ion-ios-play"></i>
                                    </a>
                                </div>
                                <div class="card__content">
                                    <h3 class="card__title">
                                        <a href="{{ route('frontend.watchMovie',[$movieNomination['slug'], config('config.default_server'), config('config.default_prioritize')]) }}">{{ $movieNomination['name'] }}</a>
                                    </h3>
                                    <h3 class="card__title">
                                        <a href="{{ route('frontend.watchMovie',[$movieNomination['slug'], config('config.default_server'), config('config.default_prioritize')]) }}">({{ $movieNomination['name_origin'] }})</a>
                                    </h3>
                            ...
                            <div class="card card--list">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-8">
                                        <div class="card__content">
                                            <h3 class="card__title">
                                                <a href="{{ route('frontend.watchMovie',[$movie['slug'], config('config.default_server'), config('config.default_prioritize')]) }}">{{ $movie['name'] }}</a>
                                            </h3>
                                            <h3 class="card__title">
                                                <a href="{{ route('frontend.watchMovie',[$movie['slug'], config('config.default_server'), config('config.default_prioritize')]) }}">({{ $movie['name_origin'] }})</a>
                                            </h3>
                                            <span class="card__category">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-4">
                                            <div class="card__cover">
                                                ...
                                                <a href="{{ route('frontend.watchMovie',[$tvSerie['slug'], config('config.default_server'), config('config.default_prioritize')]) }}" class="card__play">
                                                    <i class="icon ion-ios-play"></i>
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-8">
                                            <div class="card__content">
                                                <h3 class="card__title">
                                                    <a href="{{ route('frontend.watchMovie',[$tvSerie['slug'], config('config.default_server'), config('config.default_prioritize')]) }}">{{ $tvSerie['name'] }}
                                                    </a>
                                                </h3>
                                                <h3 class="card__title">
                                                    <a href="{{ route('frontend.watchMovie',[$tvSerie['slug'], config('config.default_server'), config('config.default_prioritize')]) }}">({{ $tvSerie['name_origin'] }})
                                                    </a>
                                                </h3>
                                                <span class="card__category">
